...
```{r}
# plot 
lambda_plot <- ggplot() + geom_histogram(aes(x = lamb, y = ..density..), color = "black", fill = "blue", alpha = 0.5) + geom_density(aes(y = ..density..)) + xlab(expression(lambda)) + ggtitle("Given data with lambda = 2")
